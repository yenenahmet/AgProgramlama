...
import com.example.yenen.agprogramlamaproje.CircleTransformation;
import com.example.yenen.agprogramlamaproje.Model.Herkez_Model;
import com.example.yenen.agprogramlamaproje.MyApi;
...
public class HerkezAdapter  extends ArrayAdapter<Herkez_Model> {
    private Context context;
    private ViewHolder viewHolder;
    private List<Herkez_Model> arrayList = new ArrayList<Herkez_Model>();

    public HerkezAdapter(Context context, List<Herkez_Model> list_item) {
